...
* [Steps to release a collection to Automation hub and Galaxy](./release_collections.md) - Manual steps to follow to release a collection.
* [AI-assisted collection releases](./release_collections_ai_assisted.md) - Using Claude Code skills (`/collection-backport-status-check`, `/stable-release`) to automate backport checks, version analysis, changelog generation, and release preparation.
