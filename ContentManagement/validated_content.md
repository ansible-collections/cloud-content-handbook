...
* All roles should define an [argument spec](https://github.com/ansible-collections/cloud-content-handbook/blob/main/Proposals/roles_arguments_validation.md).
